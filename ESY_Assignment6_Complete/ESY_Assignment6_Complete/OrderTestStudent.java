...
public class OrderTestStudent {
	...
	public void setUp() throws Exception {
		orderOne = new Order(8, Day.MONDAY, new Customer("Adam", 22));
		orderTwo = new Order(12, Day.SATURDAY, new Customer("Lincoln", 45));
		orderThree = new Order(10, Day.SUNDAY, new Customer("Madison", 21));
	}
	...
	public void testAddNewBeverage() throws NullPointerException {
		...
		orderOne.addNewBeverage("regular Coffee", Size.LARGE, true, true);
		...
		orderOne.addNewBeverage("Detox", Size.LARGE, 3, true);
	...
	public void testCalcOrderTotal() {
		orderOne.addNewBeverage("regular Coffee", Size.LARGE, true, true);
		orderOne.addNewBeverage("Mohito", Size.LARGE);
		orderOne.addNewBeverage("Detox", Size.LARGE, 7, true);

		assertEquals(15.0, orderOne.calcOrderTotal(), .01);
